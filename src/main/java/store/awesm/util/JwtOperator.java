...
public class JwtOperator {
    ...
    public JSONObject quickGenerateWithUser(User user) {
        Map<String, Object> map = new HashMap<>();
        map.put("id", user.getId());
        map.put("username", user.getUsername());
        map.put("email", user.getEmail());
        map.put("role", user.getRoles().get(user.getRoles().size() - 1).getRolename());
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("jwt", generateToken(map));
        return jsonObject;
    }
    ...
    public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiVVNFUiIsImlkIjoxLCJlbWFpbCI6InRlc3RAcXEuY29tIiwidXNlcm5hbWUiOiJ0ZXN0IiwiaWF0IjoxNTc5Nzg1MjI1LCJleHAiOjE1ODA5OTQ4MjV9.PB1NiPEy-Yk8otuUGLds-o805r_fZNB0uKs8zJc-W1I";
